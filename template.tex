\documentclass[]{polilatex}
% ========== Opções ==========
% pnumabnt - Forçar a numeração de páginas conforme a ABNT
%	(caso contrário, algorismos romanos são usados para a parte pré-textual)
...
%	http://www.poli.usp.br/en/bibliotecas/servicos/ficha-catalografica.html
